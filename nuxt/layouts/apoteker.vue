      ...
      return [
        {
          ...
          title: 'Dashboard',
          to: `/apoteker/${petugas}/dashboard`,
        },
        {
          icon: 'mdi-lock',
          title: 'Ubah Password',
          to: `/apoteker/${petugas}/ganti-password`,
        },
        {
          icon: 'mdi-pill',
          title: 'Kelola Obat',
          to: `/apoteker/${petugas}/kelola-obat`,
        },
        {
          icon: 'mdi-medical-bag',
          title: 'Antrian Obat',
          to: `/apoteker/${petugas}/antrian-obat`,
        },
        {
          icon: 'mdi-history',
          title: 'History',
          to: `/apoteker/${petugas}/history`,
        },
      ]
    },
  },
